        ...
        <tbody>
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">
              The talk is focused on deep learning-based planning and control for aerial robots
            </td>
          </tr>
          <tr className="border-t bg-gray-50">
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">
              The talk is focused on the embodied AI for human-robot interaction
            </td>
          </tr>
          <tr className="border-t bg-gray-50">
            ...
            <td className="px-4 py-2">
              The talk is focused on decentralized lifelong multi-agent pathfinding via learning
            </td>
          </tr>
          <tr className="border-t">
            ...
            <td className="px-4 py-2">
              The talk is focused on the active perception of robot swarms
            </td>
          </tr>
          <tr className="border-t bg-gray-50">
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">
              The talk is focused on the self-organizing systems for robot swarms
            </td>
          </tr>
        </tbody>
      </table>
