      ...
      <table className="min-w-full table-auto text-left">
        ...
        <tbody>
          ...
          <tr className="border-t bg-gray-50">
            <td className="px-4 py-2 whitespace-nowrap">14:30–14:50</td>
          ...
          <tr className="border-t bg-gray-50">
            <td className="px-4 py-2 whitespace-nowrap">14:50–15:10</td>
          ...
          <tr className="border-t">
            <td className="px-4 py-2 whitespace-nowrap">15:10–15:50</td>
          ...
          <tr className="border-t">
            <td className="px-4 py-2 whitespace-nowrap">16:50–17:10</td>
            <td className="px-4 py-2">Challenge Awards</td>
            <td className="px-4 py-2">—</td>
          </tr>

          <tr className="border-t bg-gray-50">
            <td className="px-4 py-2 whitespace-nowrap">17:10–17:30</td>
          ...
          <tr className="border-t bg-gray-50">
            <td className="px-4 py-2 whitespace-nowrap">17:30–17:50</td>
